      ...
      <div className="bg-stone-900 text-stone-300 text-xs px-4 py-1.5 flex flex-wrap items-center justify-between border-b border-stone-800">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <button
            ...
            className="px-2 py-0.5 rounded-md text-[11px] font-medium bg-rose-950/60 text-rose-300 hover:bg-rose-900 transition-colors flex items-center gap-1 cursor-pointer"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          <div className="relative">
            ...
            >
              {(() => {
                const conf = roleLabels[currentRole] || roleLabels.public;
            ...
            {showRoleMenu && (
              <div className="absolute left-0 mt-2 w-56 rounded-2xl bg-white shadow-xl border border-stone-200 py-1.5 z-50 animate-fade-in">
                ...
                {(Object.keys(roleLabels) as (UserRole | 'public')[]).map((r) => {
          ...
          {/* Child Switcher (If in Parent or Student role) */}
          ...
          {activeParent ? (
            <div className="flex items-center gap-2 pr-2 border-r border-stone-200">
              <div className="text-right">
                ...
                <p className="text-[10px] text-stone-400">حساب ولي الأمر</p>
              </div>
              <button
                type="button"
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-emerald-700 hover:bg-emerald-800 text-white text-xs font-bold shadow-xs transition-colors cursor-pointer"
              >
                ابدأ رحلة ابنك
              </button>
            </div>
